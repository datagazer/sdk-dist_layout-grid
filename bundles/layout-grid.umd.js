(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/flex-layout/core'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@datagazer/layout-grid', ['exports', '@angular/core', '@angular/flex-layout/core', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global.datagazer = global.datagazer || {}, global.datagazer['layout-grid'] = {}), global.ng.core, global.ng['flex-layout'].core, global.rxjs, global.rxjs.operators));
}(this, function (exports, core, core$1, rxjs, operators) { 'use strict';

    var LAYOUT_PRESETS = new core.InjectionToken('LAYOUT_PRESETS', {
    ...
    var LayoutDirective = /** @class */ (function () {
        function LayoutDirective($elementRef, $mediaMarshaller, $mediaObserver, $styleUtils, $layoutPresets) {
            ...
            this.layoutPreset$ = (function () {
                var subject$ = new rxjs.BehaviorSubject(_this.defaultLayoutPreset);
                {
                    var source$ = _this.$mediaObserver.asObservable();
                    source$.pipe(operators.map(function () { return _this.activeLayoutPreset || _this.defaultLayoutPreset; })).subscribe(subject$);
                }
                return subject$;
            })();
            this.styleChange$ = (function () {
                var source$ = rxjs.combineLatest(_this.inputValue$, _this.layoutPreset$);
        ...
        LayoutDirective = __decorate([
            __param(4, core.Inject(LAYOUT_PRESETS)),
            __metadata("design:paramtypes", [core.ElementRef,
                core$1.MediaMarshaller,
                core$1.MediaObserver,
                core$1.StyleUtils, Array])
        ], LayoutDirective);
    ...
    exports.GridFlowDirective = GridFlowDirective;
    exports.GridGapDirective = GridGapDirective;
    exports.LAYOUT_PRESETS = LAYOUT_PRESETS;
    exports.LayoutDirective = LayoutDirective;
    exports.LayoutGridModule = LayoutGridModule;
    exports.PlaceDirective = PlaceDirective;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=layout-grid.umd.js.map
